...
// Package pkg holds no code. It exists for the tests in it, which guard facts
// about the repository that no other package owns: the README's layout block
// naming every public package, and the release workflow's image names.
package pkg
