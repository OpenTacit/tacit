---
name: tacit-org
description: Show how the organization uses its playbook — cohort spread, opportunities, and proponent cohorts (aggregates only, never individuals). Use when the member invokes $tacit-org or asks who is adopting what, where practice is established, or where a technique could spread.
---
...
Show how the organization uses its playbook for the window **whatever the member wrote after the $tacit-org mention**
