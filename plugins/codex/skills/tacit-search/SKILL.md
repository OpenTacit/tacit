---
name: tacit-search
description: Search the organization's Tacit playbook for techniques relevant to a task. Use when the member invokes $tacit-search or asks to search Tacit for something.
---
...
retrieval, differing only in what they point it at: **$tacit-search** a query
you name, **$tacit-review** the work you have in flight, **$tacit-audit** a
...
**Query:** whatever the member wrote after the $tacit-search mention
