---
name: tacit-suggest
description: Research and draft techniques matched to this org's observed Tacit usage: registry-side when it has an Anthropic key, otherwise via the harness's own web search. Use when the member invokes $tacit-suggest or asks Tacit to suggest techniques.
---
