---
description: Wire this member's harness to the org Tacit registry: prompt for URL + key, save, verify
argument-hint: optional registry URL
allowed-tools: Bash(tacit:*), Bash(curl:*)
---
