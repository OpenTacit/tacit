---
description: Retrospective Tacit audit of an agent session: review what happened and follow up
argument-hint: transcript file or share URL (blank = this session)
