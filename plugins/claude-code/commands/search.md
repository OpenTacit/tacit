---
description: Search your org's Tacit playbook for validated techniques
...
1. Call the `mcp__plugin_tacit_tacit__tacit_search` MCP tool (from the `tacit` MCP server) with the
