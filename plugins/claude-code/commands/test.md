---
description: End-to-end test of the Tacit pipeline (retrieval, hooks, trigger prompt)
argument-hint: optional topic to test with
...
Optional focus topic: $ARGUMENTS
