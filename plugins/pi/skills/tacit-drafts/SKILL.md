---
name: tacit-drafts
description: Review the Tacit draft queue — promote, reject, or edit draft techniques without the dashboard. Use when the member invokes /skill:tacit-drafts or asks what's waiting for Tacit review.
---
