---
name: tacit-audit
description: Retrospective Tacit audit of an agent session: replay a finished session (transcript, share URL, or the current one) against the org's Tacit playbook and follow up with feedback, contributions, and revisions. Use when the member invokes /skill:tacit-audit or asks to audit a session.
---
...
playbook retrieval: /skill:tacit-search (a query you name), /skill:tacit-review (work in
...
2. **Recurring uncovered friction**: something the member
   ...
   it with /skill:tacit-contribute, naming the move.
