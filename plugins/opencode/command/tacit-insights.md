---
description: Tacit technique-usage metrics (funnel, helped rate) as a dashboard with text fallback — for who/where questions use /tacit-org (arguments: 7d | 30d | 90d | all (default 30d))
---
