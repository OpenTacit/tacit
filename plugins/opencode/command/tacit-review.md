---
description: Review work in flight for relevant techniques from the org's playbook and render them inline (arguments: optional focus (blank = whatever you're working on now))
---
