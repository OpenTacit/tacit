...
Search the organization's Tacit playbook for techniques relevant to a task. Use when the member invokes /tacit-search or asks to search Tacit for something.
...
**Query:** whatever the member wrote after the /tacit-search command
