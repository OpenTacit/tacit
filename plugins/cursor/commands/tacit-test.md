...
Run an end-to-end test of the Tacit pipeline (registry, retrieval, hooks) and produce a paste-ready trigger prompt. Use when the member invokes /tacit-test or asks to verify Tacit works.
...
Optional focus topic: whatever the member wrote after the /tacit-test command
