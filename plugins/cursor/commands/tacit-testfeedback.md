...
Arm a delivery self-test so one ◆ Tacit block arrives through the real hook channel at the end of this turn, proving the member would see a live suggestion. Use when the member invokes /tacit-testfeedback or asks whether Tacit's feedback actually reaches them.
