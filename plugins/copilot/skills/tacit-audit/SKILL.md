---
name: tacit-audit
description: "Retrospective Tacit audit of an agent session: replay a finished session (transcript, share URL, or the current one) against the org's Tacit playbook and follow up with feedback, contributions, and revisions. Use when the member invokes tacit audit or asks to audit a session."
---
