---
name: tacit-insights
description: "Show Tacit technique-usage metrics (funnel, helped rate) as a dashboard with text fallback. Use when the member invokes tacit insights or asks for adoption or helped-rate numbers. For who/where questions (cohorts, spread), use tacit org."
---
...
Show the organization's Tacit technique-usage insights for the window **whatever the member wrote after the "tacit insights" request**
