...
const (
	...
	// inside each platform tarball (checked for 1.27.1), so one small download
...
var runtimeLibs = map[string]Artifact{
	"linux/amd64": {
		...
		SHA256: "50e214fa23276cf2f3fb96d90d8e7ca9fc5ba29f42e298eccf3b23f7d8a81ae2",
	...
	"linux/arm64": {
		...
		SHA256: "2aede08815e740c8c1fce21af1e94353d32190127219759cc7978fb8f2de30f7",
		Member: "onnxruntime-linux-aarch64-" + Version + "/lib/libonnxruntime.so." + Version,
		Out:    "libonnxruntime.so." + Version,
	},
	"darwin/arm64": {
		URL:    base + "onnxruntime-osx-arm64-" + Version + ".tgz",
		SHA256: "a441a94433ebf38f1918009aba0199f88c6f877251b9946d89816427839964c8",
